...
#define PLATFORM_PLIC_ADDR		0xe2000000
...
#define PLATFORM_CLINT_ADDR		0xe1000000
...
#define PLATFORM_ACLINT_MTIMER_ADDR	(PLATFORM_CLINT_ADDR + \
					 CLINT_MTIMER_OFFSET)
#define PLATFORM_UART_ADDR		0xe8000000
#define PLATFORM_UART_INPUT_FREQ	100000000
#define PLATFORM_UART_BAUDRATE		912600
